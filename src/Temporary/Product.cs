    ...
    public Task Handle(HttpRequest request)
    {
        ...
        switch (productId)
        {
            case "09390028-3d57-4c34-977d-9eb78f146618":
                vm.Product = CreateProduct(Guid.Parse(productId), "Pizza", "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Eq_it-na_pizza-margherita_sep2005_sml.jpg/640px-Eq_it-na_pizza-margherita_sep2005_sml.jpg", 5, 5, 3.7, 7, "food");
                break;
            ...
            case "0b3dcc85-110b-4491-9946-d20c0a51917b":
                vm.Product = CreateProduct(Guid.Parse(productId), "Heineken", "https://media.danmurphys.com.au/dmo/product/804969-1.png?impolicy=PROD_LG", 0.5m, 1843, 4.8, 212, "beer");
                break;
        }
