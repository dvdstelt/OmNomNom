...
export default function LocationSelect() {
  ...
  const { data: locations } = useLoadData(getLocations, null, {
    callback: locationsLoaded,
  });

  function locationsLoaded(loaded) {
    if (
      !selectedLocationId ||
      !loaded.find((location) => location.id === selectedLocationId)
    )
        ...
        <div className={styles.modal}>
          ...
          <div className={styles.modalContent}>
            <span className={styles.instructions}>
              Ship options and delivery speeds may vary for different locations
            </span>
