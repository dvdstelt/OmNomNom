...
public class SeedData
{
    ...
    public static IEnumerable<Product> Products()
    {
        return new List<Product>
        {
            ...
            new Product { Name = "Mosaic Dry Hopped Fort Point", Description = "This variant on Fort Point features Mosaic in the dry hop. Pouring a cloudy, canary gold, Mosaic Fort Point emits a distinctively dank nose of pulpy, fresh squeezed orange, pungent passionfruit, ripe mango, and papaya. 6.6% ABV.", ImageUrl = "mosaicfortpoint.png", BeerStyle = "IPA", Brewery = "Trillium Brewing Company", Country = "United States", ProductId = MosaicFortPointId },
            new Product { Name = "Double Dry Hop Pseudo Sue", Description = "This double dry hopped pale ale showcases the Citra hop for a well balanced beer that is delicate in body with a mild bitterness in the finish. 5.8% ABV.", ImageUrl = "doubledryhoppseudo.png", BeerStyle = "Pale Ale", Brewery = "Toppling Goliath Brewing Co.", Country = "United States", ProductId = PseudoSueId },
            new Product { Name = "Chicken & Broccoli", Description = "An IPA brewed with hand selected Citra, and Motueka and Riwaka selected from our pals at Freestyle Hops. Tropical citrus, papaya, and some sweet orange dominate the profile. 7.5% ABV.", ImageUrl = "chickenbroccoli.png", BeerStyle = "IPA", Brewery = "Other Half Brewing Co.", Country = "United States", ProductId = ChickenBroccoliId },
            new Product { Name = "Triple Fruit Bomb", Description = "Triple Fruit Bomb takes everything you love about Fruit Bomb and dials it way up. At 9.5% it's fuller, richer and punchier, loaded with the same Mosaic, Nelson Sauvin and Citra combo - just more of it.", ImageUrl = "triplefruitbomb.png", BeerStyle = "IPA", Brewery = "Moersleutel Craft Brewery", Country = "The Netherlands", ProductId = TripleFruitBombId },
            new Product { Name = "Juice Land v4 (Mosaic, Simcoe, Amarillo)", Description = "Catch the next wave to Juice Land volume 4! In this version of our award-winning NEIIPA, we've doubled down on the juiciness with Mosaic, Simcoe, and Amarillo. This citrus bomb has notes of orange, nectarine, and grapefruit and a subtle, pleasant earthiness. 8.4% ABV.", ImageUrl = "juicelandv4.png", BeerStyle = "IPA", Brewery = "Beer Tree Brew Co", Country = "United States", ProductId = JuiceLandV4Id },
            new Product { Name = "Double Mosaic Dream", Description = "Our classic Mosaic focused Imperial IPA containing our hand selected Mosaic, Mosaic Cryo and Mosaic Incognito. Notes of blueberry, mango and orange. 8.5% ABV.", ImageUrl = "doublemosaicdream.png", BeerStyle = "IPA", Brewery = "Other Half Brewing Co.", Country = "United States", ProductId = DoubleMosaicDreamId },

            // Sours (Untappd-sourced)
            new Product { Name = "Coastal Sunshine V19 - Passion Fruit, Tangerine, Pink Guava", Description = "Tropical paradise in a can, packed with passion fruit, tangerine, and pink guava with balanced tartness and refreshing flavors. 6% ABV.", ImageUrl = "coastalsunshinev19.png", BeerStyle = "Sour", Brewery = "Humble Forager Brewery", Country = "United States", ProductId = CoastalSunshineId },

            // Mead
            new Product { Name = "Sunflowers", Description = "Made from a curated blend of many different honey varieties, Sunflowers is the ultimate traditional. Complex with alluring and beguiling aromatics, Sunflowers pairs extraordinarily well with a cheese course, almond and hazelnut flavors, and rich, luscious desserts. 10% ABV.", ImageUrl = "schrammsunflowers.png", BeerStyle = "Mead", Brewery = "Schramm's Mead", Country = "United States", ProductId = SunflowersId },
            new Product { Name = "Blue Suede Shews", Description = "Orange Blossom Honey-wine with Wild Blueberries and Cashew. 14% ABV.", ImageUrl = "bluesuedeshews.png", BeerStyle = "Mead", Brewery = "Pips Meadery", Country = "United States", ProductId = BlueSuedeShewsId },

            // Quadrupel
            new Product { Name = "La Trappe Quadrupel Oak Aged Batch #50", Description = "Aged for over two years in previously-used barrels (Wild Turkey Bourbon 55%, Cognac 26%, New Oak Medium Toast 19%) to celebrate the brewery's 140th anniversary. 12.5% ABV.", ImageUrl = "latrappeoakaged50.png", BeerStyle = "Quadrupel", Brewery = "Bierbrouwerij De Koningshoeven", Country = "The Netherlands", ProductId = LaTrappeQuad50Id },
        };
    }
