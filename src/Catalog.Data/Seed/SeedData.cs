...
public class SeedData
{
    ...
    public static IEnumerable<Product> Products()
    {
        return new List<Product>
        {
            ...
            new Product() { Name = "8719992492800 (Barcode Black & Yellow)", Description = "Blend of Cognac and Bourbon, Barrel Aged imperial stout. 14% ABV.", ImageUrl = "8719992492800.png", Category = "Stout", Brewery = "Moersleutel Craft Brewery", Country = "The Netherlands", ProductId = BarcodeBlackYellowId },
